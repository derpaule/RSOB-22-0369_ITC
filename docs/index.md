...
This script was only used to generate the figures for the manuscript.
...
```r
nitpiclist_itc = list.files(path = "./nitpic_sedphat_output", pattern = "*", recursive = TRUE, include.dirs = TRUE, full.names = TRUE)
